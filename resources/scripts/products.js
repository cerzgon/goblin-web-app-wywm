const API_URL =
  "https://api.rawg.io/api/games?key=de581a94a6ba4ff6842fcdbd5941e7a4&dates=2019-09-01,2019-09-30&platforms=18,1,7";
    ...
    if (games && games.length > 0) {
      ...
      games.forEach((game) => {
        ...
        li.innerHTML = `
                    ...
                    <p id="genre">Genre: ${game.genres
                      .map((genre) => genre.name)
                      .join(", ")}</p>
                    <p id="rating">Ratings: ${game.rating}</p>
                    <img id="img" src="${game.background_image}" alt="${
          game.name
        } Image" width="200">
                `;
        ul.appendChild(li);
